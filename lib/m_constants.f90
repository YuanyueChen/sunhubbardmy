  module constants
     ...
     complex(dp), public, parameter :: ctwo  = dcmplx(2.0_dp, 0.0_dp)
     complex(dp), public, parameter :: cthree  = dcmplx(3.0_dp, 0.0_dp)
     complex(dp), public, parameter :: cfour  = dcmplx(4.0_dp, 0.0_dp)
