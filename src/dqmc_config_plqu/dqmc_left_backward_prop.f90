subroutine dqmc_left_backward_prop(this, gmat, isite, ntau )
  ! B(t+dt,t)^-1 *gmat
  use model_para
#IFDEF _OPENMP
  USE OMP_LIB
...
#ENDIF
  ...
  call zgemm('n','n',latt%z_plq,n2,latt%z_plq,cone,this%bmat_plqu_blk1_inv(:,:,is),latt%z_plq,vkmat%blk1,latt%z_plq,czero,vkmat_tmp%blk1,latt%z_plq)
  do i0 = 1, latt%z_plq
    i1 = latt%plq_cord(i0, isite)
    do i = 1, n2
