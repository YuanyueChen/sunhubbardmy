...
#IFDEF TIMING
  real(dp) :: starttime12, endtime12
#ENDIF
#IFDEF TIMING
  starttime12 = omp_get_wtime()
#ENDIF
  ...
  call zgemm('n','n',latt%z_plq,n2,latt%z_plq,cone,this%bmat_plqu_orb1(:,:,is),latt%z_plq,vkmat%orb1,latt%z_plq,czero,vkmat_tmp%orb1,latt%z_plq)
  do i0 = 1, latt%z_plq
    i1 = latt%plq_cord(i0, isite)
    do i = 1, n2
...
#IFDEF TIMING
  endtime12 = omp_get_wtime()
  timecalculation(12)=timecalculation(12)+endtime12-starttime12
#ENDIF
