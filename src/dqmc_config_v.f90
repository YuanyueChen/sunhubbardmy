...
#if defined(DELAYLR)
#include 'dqmc_config_v/dqmc_proj_update_delay_LR2.f90'
#else
...
#if defined(DELAYLR)
#include 'dqmc_config_v/dqmc_proj_update_submatrix_LR1-2.f90'
#else
#include 'dqmc_config_v/dqmc_proj_update_submatrix.f90'
#endif
#else
