module dqmc_measure
  ...
  contains
#include 'dqmc_measure/equaltime_measure1d.f90'
#include 'dqmc_measure/equaltime_output1d.f90'
#include 'dqmc_measure/dyn_measure1d.f90'
#include 'dqmc_measure/dyn_output1d.f90'
  ...
  subroutine allocate_obs
    ...
    if(ltau) then
        ...
        allocate( zbb_tau_bin(lq) )
        allocate( zbb_tau(lq) )
        allocate( zb_tau_bin(ntdm+1) )
        allocate( zb_tau(ntdm+1) )
    end if
